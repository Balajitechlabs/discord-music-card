    ...
    return (
        <div className="max-w-xl w-full flex justify-between items-center mb-6 transition-opacity text-muted-foreground">
         ...
         <div className="flex items-center gap-3">
            <a href="https://github.com/Balajitechlabs/discord-music-card" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-full transition-all bg-secondary text-secondary-foreground hover:bg-secondary-hover hover:text-foreground border border-secondary-border shadow-sm active:scale-95" title="Star on GitHub">
